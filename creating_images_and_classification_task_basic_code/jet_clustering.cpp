...
{     vector<PseudoJet> inputList, inputList2, inputList3;
    ...
    TFile file1("/Users/apple/Delphes-3.5.0/ppjja.root","READ");
    ...
    chain.Add("/Users/apple/Delphes-3.5.0/ppjja.root");
    ...
    TFile* fileout=new TFile("/Users/apple/Documents/softwares/iyer/ppjjaout.root","recreate");
    ...
    Float_t jetmultiplicity=0;
    tree->Branch("jetmultiplicity", &jetmultiplicity, "jetmultiplicity/F");
    Float_t transverse_energy=0;
    tree->Branch("transverse_energy", &transverse_energy, "transverse_energy/F");
    Float_t tj = 0;
    tree->Branch("thetaJ for QCD jet", &tj, "tj/F");
    
    
  
    ofstream variables7;
    ///  variables7.open("/Users/abhishekiyer/Dropbox/chargedvsneutral/HLfiles/zpmu14_4.txt",  std::ios::app);
    variables7.open("/Users/apple/Documents/softwares/iyer/text_files/ppjjaout.txt",  std::ios::app);
   ...
   //vector pseudojet outputlist;
        ...
        jetmultiplicity = numjets;
          ...
          //   Float_t phig2 = outputList[0].phi();
             ...
             //    cout << "ehadron " << Ehadron << "\n";
                // Float_t thetaJ = log(Ehad/Etot);
     ...
     //   cout << "delta R value is " << deltaR << "\n";
      ...
      if (outputList.size() > 0)
      {
        ...
        //  Float_t Etot = outputList[0].E();
        //   cout << "etotal " << Etot << "\n";
        //  Float_t  neutrinoE = outputList[1].E();
       //   transverse_energy = neutrinoE/cosh(ljeta);
         // cout << "ljeta and ljphi " << ljeta << "\t" << ljphi <<  "\n" ;
        //  cout << "transverse energy of neutrino " << transverse_energy << "\n" ;
      ...
      //    cout << "constituents size is " << constituents.size()<< "\n";
          ...
          //    cout << " constituent " << l << "’s eta: "<< constituents[l].perp() << endl;
             // cout << "checking 1 " << tracksize << "\n";
              coneta = constituents[l].eta();
              conphi = constituents[l].phi();
              conEnergy = constituents[l].E();
              transverse_energy = conEnergy/cosh(coneta);
            //  cout << "coneta and conphi " << coneta << "\t" << conphi <<  "\n" ;
             /* if(constituents[l].user_index()==2)
              {
                  Ehadron = constituents[l].E();
                  
                  cout << "ehadron " << Ehadron << "\n";
                  thetaJ = log (Ehadron/Etot);
              }*/
             ...
             // cout << "thetaj " << thetaJ << "\n";
              ...
              if( constituents[l].user_index() == 0)
              {
              ...
              // if(tracksize==2)
            //   {cout <<entry << "\t"<< "yay" << "\n" ;}
           //   variables7<<setprecision(3)<<thetaJ<< "\t" << "\n";
             // variables7<<setprecision(3)<<constituents[l].phi()<< "\t" << constituents[l].eta() << "\n";

           //   cout << "eta and phi " << constituents[l].phi() << "\t" <<constituents[l].eta()<< "\n";
              
               
              Float_t deltaetaj =0;
              Float_t deltaphij = 0;
              deltaetaj = ljeta - coneta;
              deltaphij = ljphi - conphi;
              cout << "deltaetaj and deltaphij and energy" << "\t" << deltaetaj << "\t" << deltaphij <<"\t" << transverse_energy <<  "\n" ;
            //  cout<<entry<<"\t"<<constituents.size()<<"\n";
              variables7<<setprecision(3)<<deltaetaj<< "\t" << deltaphij<< "\t" << transverse_energy << "\n";
          }
          
          
      }
     //   cout <<entry <<  "number of tracks " << tracksize << "\n";
        numtracks = tracksize;
    //    tj = thetaJ;
    //    if (numtracks==2)
      //  {}
       
   //     invariant_mass = sqrt(pow(Einv,2)-pow(pxinv,2)-pow(pyinv,2)-pow(pzinv,2));
        ...
        //
            ...
            //     variables7<<setprecision(3)<<<<"\t"<<numjets<<"\n";
